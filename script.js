...
function renderProducts(){
  ...
  $('#product-grid').innerHTML = `${productCards}<article class="product-card coming-product"><div class="product-visual"><div class="construction-site" aria-label="אתר בנייה מאויר"><div class="skyline"><i class="building building-a"><b></b><b></b><b></b></i><i class="building building-b"><b></b><b></b><b></b><b></b></i><i class="building building-c"><b></b><b></b></i></div><div class="crane crane-one"><span class="crane-mast"></span><span class="crane-arm"></span><span class="crane-cable"></span><span class="crane-load"></span></div><div class="crane crane-two"><span class="crane-mast"></span><span class="crane-arm"></span><span class="crane-cable"></span><span class="crane-load"></span></div><div class="construction-ground"></div></div><div class="coming-copy"><strong>בקרוב תצא<br>חולצה חדשה</strong><small>האתר בבנייה</small></div><span class="product-index">02 / 02</span><span class="product-color">COMING SOON</span></div><div class="product-info"><div class="product-title">חולצה נוספת</div><div class="product-description">אנחנו עובדים עליה. היא תגיע בקרוב.</div><div class="price-row"><span class="coming-label">בקרוב</span><span class="coming-dash">—</span></div></div></article>`;
