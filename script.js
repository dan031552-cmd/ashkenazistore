...
function renderProducts(){
  ...
  $('#product-grid').innerHTML = `${productCards}<article class="product-card coming-product"><div class="product-visual"><div class="construction-scene"><div class="construction-paper"><span class="construction-line"></span><span class="construction-line"></span><span class="construction-line short"></span></div><div class="construction-pencil">✎</div><div class="construction-dots">•••</div></div><div class="coming-copy"><strong>בקרוב<br>תצא חולצה<br>חדשה</strong><small>בבנייה עכשיו</small></div><span class="product-index">02 / 02</span><span class="product-color">COMING SOON</span></div><div class="product-info"><div class="product-title">חולצה נוספת</div><div class="product-description">אנחנו עובדים עליה. היא תגיע בקרוב.</div><div class="price-row"><span class="coming-label">בקרוב</span><span class="coming-dash">—</span></div></div></article>`;
